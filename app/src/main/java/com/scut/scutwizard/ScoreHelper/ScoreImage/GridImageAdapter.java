...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(com.scut.scutwizard.R.layout.gv_filter_image,
                                      viewGroup,
                                      false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(com.scut.scutwizard.R.drawable.ic_add_image);
...
//            int chooseModel = media.getChooseModel();
            ...
            }
            {
                Glide.with(viewHolder.itemView.getContext())
                     .load(isAndroidQ && !media.isCut() && !media.isCompressed() ? Uri.parse(path)
                                                                                 : path)
                     .centerCrop()
                     .placeholder(com.scut.scutwizard.R.color.app_color_f6)
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View view) {
            super(view);
            mImg = view.findViewById(com.scut.scutwizard.R.id.fiv);
            mIvDel = view.findViewById(com.scut.scutwizard.R.id.iv_del);
        }
    }
}
